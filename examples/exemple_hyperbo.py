...
F0 = build_exemple_1_F0()
(Ftype, d) = give_F_format(F0)
print(f"Ftype: {Ftype}, d: {d}")

F1 = build_exemple_1_F1()
(Ftype, d) = give_F_format(F1)
print(f"Ftype: {Ftype}, d: {d}")
Fx,Fy=F1
...
########         
#############################################################################################
# MASSE_H.spy_hyperbo(d=3, tol=1e-8,secondes=3)
# F1D1.spy_hyperbo(d=3, tol=1e-8,secondes=3)
# F2D2.spy_hyperbo(d=3, tol=1e-8,secondes=3)
